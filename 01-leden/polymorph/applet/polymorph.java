...
public class polymorph extends PApplet {
...
public class Morpher{
	...
	public void draw(){
		stroke(lerpColor(0xffFFFFFF,0xffFFCC00,norm(zivo,333,0)),map(ttl,0,bttl,0,128));
		noFill();
	...
	public void modX(float _x,float sp){
		xx+=(_x-x)/sp;
	
	}
	
	
	public void modY(float _y,float sp){
		yy+=(_y-y)/sp;
...
public class Snake extends Morpher{
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#dfdfdf", "polymorph" });
  }
}
